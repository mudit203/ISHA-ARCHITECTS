...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 flex flex-col items-center justify-center mt-16">
        <div className="text-center flex flex-col gap-18">
          <div className='flex justify-center items-center flex-col'>
            <motion.span 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.2 }}
              className='text-4xl lg:text-8xl font-extrabold'
            >
              Welcome to
            </motion.span>
            <motion.span 
              ...
              className='text-4xl lg:text-8xl font-extrabold bg-yellow-500 p-3 rounded-lg'
            >
              ISHA ARCHITECTS
            </motion.span>
          </div>
